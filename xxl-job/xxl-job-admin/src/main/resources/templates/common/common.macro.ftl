	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if loginUser.role == 1>
					<li class="nav-click <#if pageName == "jobinfoCheck">active</#if>" ><a href="${request.contextPath}/jobinfoCheck"><i class="fa fa-circle-o text-green"></i><span>检查任务</span></a></li>
					<li class="nav-click <#if pageName == "joblog">active</#if>" ><a href="${request.contextPath}/joblog"><i class="fa fa-circle-o text-green"></i><span>操作记录</span></a></li>
